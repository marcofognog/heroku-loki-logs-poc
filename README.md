## Heroku logs with Loki

1. Create an account in grafana Labs. 
2. Replace credentials in the .tfvars file.
3. run terrform apply.
4. Go to grafana labs build cool charts.
